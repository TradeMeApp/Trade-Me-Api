...
export class CommentResolverBase {
  ...
  async createComment(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        commented: args.data.commented
          ? {
              connect: args.data.commented,
            }
          : undefined,
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Comment], { name: "commentOn" })
  @nestAccessControl.UseRoles({
    resource: "Comment",
    action: "read",
    possession: "any",
  })
  async resolveFieldCommentOn(
    @graphql.Parent() parent: Comment,
    @graphql.Args() args: CommentFindManyArgs
  ): Promise<Comment[]> {
    const results = await this.service.findCommentOn(parent.id, args);
  ...
  async resolveFieldCommented(
    ...
    const result = await this.service.getCommented(parent.id);
